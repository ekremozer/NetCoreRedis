...
namespace NetCoreRedis.Web
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, RedisStackExchangeCacheManager redisStackExchangeCacheManager)
        {
